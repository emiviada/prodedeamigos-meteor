...
(function(jQuery)
{
  jQuery.fn.clock = function(options)
  {
    ...
    setInterval( function() {
      var seconds = jQuery.addZero(jQuery.calcTime(opts.offset).getSeconds());
      if(opts.type=='analog')
      {
    ...
    setInterval( function() {
      var hours = jQuery.addZero(jQuery.calcTime(opts.offset).getHours());
      var mins = jQuery.addZero(jQuery.calcTime(opts.offset).getMinutes());
      if(opts.type=='analog')
      {
